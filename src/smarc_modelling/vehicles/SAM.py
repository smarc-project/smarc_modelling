...
if __name__ == "__main__":
    state = np.array([ 9.14858505e+00 , 1.50390851e+00 , 5.03598088e-01  , 9.98568953e-01,
            2.23832741e-03,  1.14489037e-02,  5.44947496e-02, -5.56199329e-01,
            4.59815999e-02, -3.53929948e-03,  2.04329833e-02,  4.19439456e-03,
            1.60962712e-01,  5.00000000e+01,  5.00000000e+01,  0.00000000e+00,
            8.72664626e-02, -9.00000000e+02, -9.00000000e+02])
    input = np.array([50, 50, 0, 1.13446401e-01, 1000, 1000])
    '''
    expected_res = [-5.57833425e-01 -1.48272580e-02  9.30326616e-03 -4.43214531e-03
                    1.10076561e-02  2.47049412e-03  8.02440520e-02 -3.86010518e-01
                    6.35011639e-02 -2.12153603e-03 -2.13339007e-01 -4.68760315e-02
                    7.38475274e-02  0.00000000e+00  0.00000000e+00  0.00000000e+00
                    2.61799388e-01  1.90000000e+04  1.90000000e+04]
    '''
    dt = 0.1
    sam = SAM(dt)
    print(sam.dynamics(state, input))